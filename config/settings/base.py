...
ROOT_DIR = environ.Path(__file__) - 3  # (delivery/config/settings/base.py - 3 = delivery/)
...
MIGRATION_MODULES = {
    'sites': 'delivery.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Terry McDonnell""", 'tldelivery@guardsmen.org'),
]
